...
export default function EducationPlanningCalculator() {
    ...
    const calculateEducationPlan = () => {
        const years = educationStartAge - currentAge; // Time left until education starts
        ...
        // Calculate future cost of education considering inflation
        const futureEducationCost = totalInvestment * Math.pow(1 + inflationRateDecimal, years);

        // Calculate the lumpsum amount needed today to reach the future cost
        const lumpsumInvestment = futureEducationCost / Math.pow(1 + annualReturnRate, years);

        // Calculate monthly SIP amount needed to accumulate the future cost
        const monthlyReturnRate = annualReturnRate / 12;
        const months = years * 12;
        const sipInvestment = futureEducationCost / ((Math.pow(1 + monthlyReturnRate, months) - 1) / monthlyReturnRate);
