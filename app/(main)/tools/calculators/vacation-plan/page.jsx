...
export default function Page() {
    ...
    const calculateVacationPlan = () => {
        ...
        // Calculate the future cost of the vacation, adjusted for inflation
        const futureVacationCost = totalInvestment * Math.pow(1 + inflationRateDecimal, years);

        // Calculate the lumpsum amount needed today to reach the future cost
        const lumpsumInvestment = futureVacationCost / Math.pow(1 + annualReturnRate, years);

        // Calculate the monthly SIP amount needed to accumulate the future vacation cost
        const monthlyReturnRate = annualReturnRate / 12; // Convert to monthly rate
        const months = years * 12; // Total number of months
        const sipInvestment = futureVacationCost / ((Math.pow(1 + monthlyReturnRate, months) - 1) / monthlyReturnRate);
        ...
        for (let year = 1; year <= years; year++) {
            // Calculate the total future vacation cost up to this year, adjusting for inflation
