        ...
        if (assetClass) {
            setSelectedAssets((prevSelected) => {
                ...
                if (updatedSelection.has(assetClass)) {
                    ...
                    console.log(`Removed: ${assetClass}`);
                } else {
                    // If not selected, add it
                    updatedSelection.add(assetClass);
                    console.log(`Added: ${assetClass}`);
                }

                console.log('Updated selected assets:', Array.from(updatedSelection)); // Log current selections
            ...
            <div className="mb-5">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/tools">Performance</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                        ...
                        <div className="sip-calculator container mx-auto p-3 sticky top-0 z-10">
                            ...
                            <div className="grid grid-cols-6">
                                ...
                                <div className="col-span-1 mt-2 overflow-y-auto p-2">
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="schemeName" className="text-sm block font-semibold text-gray-700 mb-1">SIP Amount (Monthly)</label>
                                        <input
                                            type="number"
                                            id="schemeName"
                                ...
                                <div className="col-span-1 mt-2 overflow-y-auto p-2">
                                    <div className="mb-4">
                                        <label htmlFor="schemeDate" className="text-sm block font-semibold text-gray-700 mb-1">SIP Start Date</label>
                                        <input
                                            type="date"
                                            id="schemeDate"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                ...
                                <div className="col-span-1 mt-2 overflow-y-auto p-2">
                                    <div className="mb-4">
                                        <label htmlFor="schemeDate" className="text-sm block font-semibold text-gray-700 mb-1">SIP End Date</label>
                                        <input
                                            type="date"
                                            id="schemeDate"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                ...
                                <div className="col-span-1 mt-2 overflow-y-auto p-2">
                                    <div className="mb-4">
                                        <label htmlFor="schemeDate" className="text-sm block font-semibold text-gray-700 mb-1">Valuation As On</label>
                                        <input
                                            type="date"
                                            id="schemeDate"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
